#!/usr/bin/env python3
"""
Lazada Feed Auto-Poster: Step 3 (Bluesky Module)
Workflow Runner:
...
7. Update 'post_results.bluesky' inside 'temp/lazada_payload.json'.
"""
...
def parse_bluesky_facets(text: str):
    ...
    # 1. Ekstrak URLs (Pautan Web / Lazada)
...
def post_to_bluesky_feed(handle: str, app_password: str, caption: str, image_url: str, product_name: str):
    ...
    if blob_ref:
        record_payload["embed"] = {
            ...
            "images": [
                {
                    "alt": f"Tawaran Lazada: {product_name[:60]}",
                    "image": blob_ref
                }
            ]
        }
...
def run_bluesky_posting():
    print("\n" + "=" * 70)
    print("🦋 [START] MEMULAKAN HANTARAN LAZADA KE BLUESKY FEED")
    print("=" * 70)
